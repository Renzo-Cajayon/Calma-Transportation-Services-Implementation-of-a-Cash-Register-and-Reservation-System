    ...
    <div className={`admin-shell ${sidebarOpen ? "sidebar-open" : ""}`} style={{ minHeight: '100vh', backgroundColor: '#F8FAFC', width: '100vw', overflowX: 'hidden' }}>
      ...
      <aside className="admin-sidebar bg-dark text-white p-4 shadow">
        ...
        <nav className="nav flex-column gap-2">
          ...
          <Link to="/admin/cars" onClick={() => setSidebarOpen(false)} className="nav-link active text-white bg-primary p-3 rounded mb-1 shadow-sm">
            <i className="fa fa-car mr-2"></i> Car Inventory
          </Link>
          <Link to="/admin/reservations" onClick={() => setSidebarOpen(false)} className="nav-link text-white-50 p-3 rounded mb-1">
