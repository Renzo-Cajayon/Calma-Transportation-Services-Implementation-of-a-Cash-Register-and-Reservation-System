...
app.post('/api/reserve', (req, res) => {
    ...
    const dbPaymentMethod = paymentMethod === 'Cash on Pick-up' ? 'Cash' : 'Online';
    ...
    db.query(sql, [userId, carName, startDate, endDate, total, dbPaymentMethod, referenceNumber], (err, result) => {
        if (err) {
