    ...
    <div className="user-layout-wrapper d-flex flex-column" style={{ minHeight: '100vh', backgroundColor: '#f8fafc' }}>
      ...
      <nav className="navbar navbar-expand-lg navbar-dark fixed-top shadow" style={{ backgroundColor: '#0f172a', padding: '15px 0', borderBottom: '1px solid #1e293b', zIndex: 1050 }}>
        <div className="container">
          ...
          <div className="collapse navbar-collapse show" id="userNav">
            <ul className="navbar-nav ml-auto align-items-center" style={{ gap: '5px' }}>
              <li className="nav-item"><Link to="/" className="nav-link text-white px-3 font-weight-medium">Home</Link></li>
              <li className="nav-item"><Link to="/cars" className="nav-link text-white px-3 font-weight-medium">Cars</Link></li>
              <li className="nav-item"><Link to="/reservations" className="nav-link text-white px-3 font-weight-medium">My Bookings</Link></li>
              <li className="nav-item"><Link to="/profile" className="nav-link text-white px-3 font-weight-medium">Profile</Link></li>
              <li className="nav-item"><Link to="/about" className="nav-link text-white px-3 font-weight-medium">About</Link></li>
              
              {userRole === 'admin' && (
                <li className="nav-item ml-2">
                  <Link to="/admin" className="nav-link text-dark font-weight-bold px-3 py-2 bg-warning rounded-pill shadow-sm" style={{ fontSize: '13px' }}>
